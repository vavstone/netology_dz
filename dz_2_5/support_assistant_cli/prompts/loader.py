...
def _build_messages(system_prompt: str, user_message: str, history: list[dict[str, str]] | None = None) -> list[dict[str, str]]:
...
def build_answer_messages(system_prompt: str, history: list[dict[str, str]], user_message: str) -> list[dict[str, str]]:
    ...
    return _build_messages(system_prompt, user_message, history)
...
def build_classifier_messages(system_prompt: str, user_message: str) -> list[dict[str, str]]:
    ...
    return _build_messages(system_prompt, user_message, None)